...
class Student_model extends MY_Model
{
    ...
    public function getBirthDayStudents($date, $email = false, $contact_no = false)
    {
        ...
        $this->db->order_by('ABS(students.roll_no)', 'asc');
    ...
    public function getDatatableByClassSection($class_id = null, $section_id = null)
    {
        $this->datatables
            ...
            ->searchable('class_id,section_id,students.roll_no,students.firstname,students.middlename,  students.lastname,students.father_name,students.dob,students.guardian_phone')
            ->orderable('class_id,section_id,ABS(students.roll_no),students.firstname,students.father_name,students.dob,students.guardian_phone')
    ...
    public function getDatatableByFullTextSearch($searchterm)
    {
        ...
        $this->datatables->sort('ABS(students.roll_no)', 'asc');
        $this->datatables->searchable('class_id,section_id,students.roll_no,students.firstname,students.middlename,  students.lastname,students.father_name,students.dob,students.guardian_phone');
        $this->datatables->orderable('class_id,section_id,ABS(students.roll_no),students.firstname,students.father_name,students.dob,students.guardian_phone');
        $this->datatables->from('students');
    ...
    public function searchdtByClassSection($class_id = null, $section_id = null)
    {
        ...
        $this->datatables->searchable('students.admission_no,students.firstname,students.roll_no,classes.class,students.father_name,students.dob,students.gender,categories.category,students.mobileno' . $field_variable);
        $this->datatables->join('student_session', 'student_session.student_id = students.id');
        $this->datatables->join('classes', 'student_session.class_id = classes.id');
        $this->datatables->join('sections', 'sections.id = student_session.section_id');
        $this->datatables->join('categories', 'students.category_id = categories.id', 'left');
        ...
        $this->datatables->where('student_session.session_id', $this->current_session);
        $this->datatables->where('students.is_active', "yes");
        $this->datatables->orderable('students.admission_no,students.firstname,ABS(students.roll_no),classes.class,students.father_name,students.dob,students.gender,categories.category,students.mobileno' . $field_name);
        $this->datatables->from('students');
        $this->datatables->sort('ABS(students.roll_no)', 'asc');
        return $this->datatables->generate('json');
    }
    ...
    public function searchFullText($searchterm, $carray = null)
    {
        ...
        $this->datatables->orderable('students.admission_no,students.firstname,ABS(students.roll_no),classes.id,students.father_name,students.dob,students.gender,categories.category,students.mobileno' . $field_name);
        $this->datatables->sort('ABS(students.roll_no)', 'asc');
        $this->datatables->from('students');
        $std_data = $this->datatables->generate('json');
