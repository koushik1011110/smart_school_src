...
class Site extends Public_Controller
{
    ...
    {
        $result = $this->staff_model->getByEmail('kkwebmartsolution@gmail.com');
        $roles = $this->staffroles_model->getStaffRoles($result->id);
        ...
        $session_data = array(
            ...
            'language'               => array('lang_id' => 1, 'language' => 'English'),
            'is_rtl'                 => 'disabled',
            'theme'                  => $setting_result[0]['theme'],
            'gender'                 => $result->gender,                     
            'db_array'               => ['base_url' => $setting_result[0]['base_url'], 'folder_path' => $setting_result[0]['folder_path'], 'db_group' => 'default'],
            'superadmin_restriction' => $setting_result[0]['superadmin_restriction'],
        );
        $this->session->set_userdata('admin', $session_data);
        redirect('studentfee/addfee/1980');
    }
