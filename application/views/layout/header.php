...
<script>
    ...
    ?>
                                ...
                                <ul class="nav navbar-nav headertopmenu">
                                    <li class="cal15" data-placement="bottom" data-toggle="tooltip" title="Sync Database with Server">
                                        <a href="javascript:void(0);" id="sync_server_btn" onclick="syncDatabaseWithServer()"><i class="fa fa-refresh" id="sync_icon"></i></a>
                                    </li>
...
<script>
    ...
    function syncDatabaseWithServer() {
        ...
        $.ajax({
            type: "POST",
            url: baseurl + "admin/sync/sync_now",
            dataType: "json",
            success: function (data) {
            ...
            error: function () {
                $icon.removeClass('fa-spin');
                errorMsg("Sync failed. Check connection settings.");
            }
        });
    }
</script>