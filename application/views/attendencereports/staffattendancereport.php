                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        ?>
                                                            <th class="tdcls text text-center">
                                                                <?php
                                                                $attendance_detail = isset($resultlist[$at_value][$student_value['id']]) ? $resultlist[$at_value][$student_value['id']] : array();
                                                                $attendance_time   = "";
                                                                $check_out_time    = "";

                                                                if (!empty($attendance_detail['attendence_dt']) && $attendance_detail['attendence_dt'] != '0000-00-00 00:00:00') {
                                                                    $attendance_time = date('H:i:s', strtotime($attendance_detail['attendence_dt']));
                                                                }

                                                                if (!empty($attendance_detail['check_out_time']) && $attendance_detail['check_out_time'] != '00:00:00') {
                                                                    $check_out_time = date('H:i:s', strtotime($attendance_detail['check_out_time']));
                                                                }
                                                                ?>
                                                                <span data-toggle="popover" class="detail_popover" data-original-title="" title=""><a href="#" style="color:#333"><?php
                                                                                                                                                                                    echo isset($attendance_detail['key']) ? $attendance_detail['key'] : "";
                                                                                                                                                                                    if ($attendance_time != "") {
                                                                                                                                                                                        echo "<br/><small>In: " . $attendance_time . "</small>";
                                                                                                                                                                                    }
                                                                                                                                                                                    if ($check_out_time != "") {
                                                                                                                                                                                        echo "<br/><small>Out: " . $check_out_time . "</small>";
                                                                                                                                                                                    }
                                                                                                                                                                                    ?></a></span>
                                                                <div class="fee_detail_popover" style="display: none"><?php
                                                                                                                        if ($attendance_time != "") {
                                                                                                                            echo "Check In: " . $attendance_time . "<br/>";
                                                                                                                        }
                                                                                                                        if ($check_out_time != "") {
                                                                                                                            echo "Check Out: " . $check_out_time . "<br/>";
                                                                                                                        }
                                                                                                                        if (!empty($attendance_detail['remark'])) {
                                                                                                                            echo $attendance_detail['remark'];
                                                                                                                        }
                                                                                                                        ?></div>
                                                            </th>
                                                        <?php
...
<script type="text/javascript">
    $('.detail_popover').popover({
        ...
        html: true,
        content: function() {
            return $(this).closest('td, th').find('.fee_detail_popover').html();
        }
    });
