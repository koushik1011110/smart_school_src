                    ...
                    foreach ($student_list as $student_key => $student) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a target="_blank"
                                    href="<?php echo site_url('student/view/' . $student['id']); ?>"><?php echo $this->customlib->getFullName($student['firstname'], $student['middlename'], $student['lastname'], $sch_setting->middlename, $sch_setting->lastname); ?>
                                </a>
                            </td>
