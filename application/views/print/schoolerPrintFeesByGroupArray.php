        ...
        <?php 
            ...
            if (!empty($feearray)) {
                foreach ($feearray as $feeList) {
                    ...
                    // Schooler print: entire fee is considered paid
                    $schooler_paid = $fee_amount;
                    ...
                    if (!isset($grouped_fees[$group_key])) {
                        ...
                        $grouped_fees[$group_key]['paid'] += $schooler_paid;
                    }
                }
            }
        ?>
                                        ...
                                        <table class="table table-striped table-responsive" style="font-size: 8pt;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="dark-gray">
                                                    ...
                                                    <td class=""><?php echo $this->lang->line('paid'); ?></td>
                                                    ...
                                                    <td class="text text-right"><?php echo $currency_symbol . amountFormat(0); ?></td>
                                                    <td class="text text-right"><?php echo $currency_symbol . amountFormat(0); ?></td>
                                                </tr>
                                                <?php } ?>
                                                <tr class="success">
                                                    ...
                                                    <td class="text text-right">
                                                        <b><?php echo $currency_symbol . amountFormat(0); ?></b>
                                                    </td>
                                                    <td class="text text-right">
                                                        <b><?php echo $currency_symbol . amountFormat(0); ?></b>
                                                    </td>
