        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form action="<?php echo site_url('studentfee/search') ?>" method="post"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-sm pull-right"
                                                    name="class_search" data-loading-text="Please wait.."
                                                    value="class_search"><i class="fa fa-search"></i>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="search_text" id="search_text"
                                                    class="form-control" value="<?php echo set_value('search_text'); ?>"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary btn-sm pull-right"
                                                    name="keyword_search" data-loading-text="Please wait.."
                                                    value="keyword_search"><i class="fa fa-search"></i>
                                                    <?php echo $this->lang->line('search'); ?></button>
                                            </div>
                                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover student-list"
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo $this->lang->line('student'); ?>
                                                <?php echo $this->lang->line('name'); ?></th>
            ...
            $.ajax({
                ...
                success: function (response) { // your success handler
                    if (!response.status) {
                        ...
                        initDatatable('student-list', 'studentfee/ajaxSearch', response.params, [], 100, [{ "bSortable": false, "aTargets": [ -1 ] ,'sClass': 'dt-body-right'}], true, [[2, 'asc']]);
                    }
                },
