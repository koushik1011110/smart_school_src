...
$target_amount   = "0";
            ...
            foreach ($student_array['fee_detail'] as $key => $fee) {
                ...
                if ($fee['date'] == "xxx") {
                    ...
                    $total_row       = amountFormat(($fee['amount'] + $fee['discount']) - $fee['fine']);
                }
                ?>
                                                    <tr>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><?php echo amountFormat($target_amount); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th><?php echo $this->lang->line('total_paid_fees'); ?> :</th>
                                                        <td><?php echo amountFormat($deposite_amount); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th><?php echo $this->lang->line('total_balance'); ?>:</th>
                                                        <td><?php echo amountFormat($target_amount - $deposite_amount); ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
