 ...
 $(document).on('click', '.printSelected', function () {
    ...
    function Popup(data, winload = false)
    {
        ...
        if (data.indexOf('<html') > -1) {
            ...
            var burl = (typeof base_url !== 'undefined') ? base_url : ((typeof baseurl !== 'undefined') ? baseurl : '');
            content += '<html lang="en"><head><title></title>';
            content += '<link rel="stylesheet" href="' + burl + 'backend/bootstrap/css/bootstrap.min.css">';
            content += '<link rel="stylesheet" href="' + burl + 'backend/dist/css/font-awesome.min.css">';
            content += '<link rel="stylesheet" href="' + burl + 'backend/dist/css/ionicons.min.css">';
            content += '<link rel="stylesheet" href="' + burl + 'backend/dist/css/AdminLTE.min.css">';
            content += '<link rel="stylesheet" href="' + burl + 'backend/dist/css/print_fee_receipt.css">';
            content += '</head><body>';
            content += data;
            content += '</body></html>';
        }
        ...
        if (content.indexOf('print_fee_receipt.css') === -1) {
            var burl = (typeof base_url !== 'undefined') ? base_url : ((typeof baseurl !== 'undefined') ? baseurl : '');
            content = content.replace('<head>', '<head><link rel="stylesheet" href="' + burl + 'backend/dist/css/print_fee_receipt.css">');
        }
