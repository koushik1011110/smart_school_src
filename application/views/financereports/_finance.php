            ...
            <div class="">
                <ul class="reportlists">
                    ...
                    <?php } if ($this->rbac->hasPrivilege('fees_collection_report', 'can_view')) { ?>
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/feetype_collection_summary'); ?>"><a href="<?php echo base_url(); ?>financereports/feetype_collection_summary"><i class="fa fa-file-text-o"></i> Fee Type Collection Summary</a></li>
