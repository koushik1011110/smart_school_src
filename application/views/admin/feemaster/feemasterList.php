            ...
            ?>">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        ...
                        <?php if ($this->rbac->hasPrivilege('fees_master', 'can_add')) { ?>
                            <button type="button" class="btn btn-sm btn-primary pull-right" data-toggle="modal" data-target="#copyFeeModal">
                                <i class="fa fa-copy"></i> <?php echo $this->lang->line('copy_to_session'); ?>
                            </button>
                        <?php } ?>
                    </div><!-- /.box-header -->
                    <div class="box-body">
...
<!-- Copy Fee Modal -->
<div class="modal fade" id="copyFeeModal" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title"><?php echo $this->lang->line('copy_fee_master'); ?></h4>
            </div>
            <form id="copyFeeForm" action="<?php echo base_url() ?>admin/feemaster/copyToSession" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="target_session"><?php echo $this->lang->line('select_session'); ?></label>
                        <select name="target_session" id="target_session" class="form-control" required>
                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                            <?php
                    ...
                    <div class="alert alert-info">
                        <i class="fa fa-info-circle"></i> <?php echo $this->lang->line('copy_fee_warning'); ?>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal"><?php echo $this->lang->line('cancel'); ?></button>
                    <button type="submit" class="btn btn-primary"><?php echo $this->lang->line('copy'); ?></button>
                </div>
            </form>
        </div>
    </div>
