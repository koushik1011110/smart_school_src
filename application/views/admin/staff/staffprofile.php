                    ...
                    <div class="studentsidetopfixed">
                        ...
                        <ul class="nav nav-justified studenttaps">
                            <?php foreach ($roles as $role_key => $role_value) {
                                ...
                                ?>><a
                                        href="#role<?php echo $role_value["id"] ?>"
                                        data-toggle="tab"><?php echo $role_value["name"] ?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
                    <!-- Tab panes -->
                                    ...
                                    if ($rolet_value['id'] == $svalue["role_id"]) {
                                        ...
                                        <div class="studentname">
                                            <a href="<?php echo base_url() . "admin/staff/profile/" . $svalue["id"] ?>">
                                                <div class="icon"><img
                                                        src="<?php echo $this->media_storage->getImageURL("uploads/staff_images/" . $image); ?>"
                                                        alt="<?php echo $this->lang->line('user_image'); ?>"></div>
                                                <div class="student-tittle">
                                                    <?php echo $svalue['name'] . " " . $svalue['surname']; ?></div>
                                            </a>
                                        </div>
                                        <?php
                                    }
                    ...
                    <div class="box-body box-profile">
                        ...
                        <?php if ($staff['user_type'] == 'Teacher') {
                            ...
                            <?php if ($rate_canview == 1) { ?>
                                ...
                                <center>
                                    <h5><?php echo substr($rate, 0, 3); ?> average based on <?php echo $reviews; ?>
                                        <?php echo $this->lang->line('reviews'); ?>.</h5>
                                </center> <?php }
                        } ?>
                        <ul class="list-group list-group-unbordered">

                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('staff_id'); ?></b> <a
                                    class="pull-right text-aqua"><?php echo $staff['employee_id']; ?></a>
                            </li>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('role'); ?></b> <a
                                    class="pull-right text-aqua"><?php echo $staff['user_type']; ?></a>
                            </li>
                            <?php if ($sch_setting->staff_designation) { ?>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('designation'); ?></b> <a
                                        class="pull-right text-aqua"><?php echo $staff['designation']; ?></a>
                                </li>
                            <?php }
                            if ($sch_setting->staff_department) { ?>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('department'); ?></b> <a
                                        class="pull-right text-aqua"><?php echo $staff['department']; ?></a>
                                </li>
                            <?php }
                            if ($sch_setting->staff_epf_no) { ?>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('epf_no'); ?></b> <a
                                        class="pull-right text-aqua"><?php echo $staff['epf_no']; ?></a>
                                </li>
                            <?php } ?>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('basic_salary'); ?></b> <a
                                    class="pull-right text-aqua"><?php if (!empty($staff['basic_salary'])) {
                            ...
                            <?php if ($sch_setting->staff_contract_type) {
                                ?>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('contract_type'); ?></b> <a
                                        class="pull-right text-aqua"><?php
                            ...
                            if ($sch_setting->staff_work_shift) { ?>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('work_shift'); ?></b> <a
                                        class="pull-right text-aqua"><?php echo $staff['shift']; ?></a>
                                </li>
                            <?php }
                            if ($sch_setting->staff_work_location) { ?>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('work_location'); ?></b> <a
                                        class="pull-right text-aqua"><?php echo $staff['location']; ?></a>
                                </li>
                            <?php }
                            if ($sch_setting->staff_date_of_joining) {
                                ?>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('date_of_joining'); ?></b> <a
                                        class="pull-right text-aqua"><?php
                            ...
                            if (($staff["is_active"] == 0)) {
                                ?>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('date_of_leaving'); ?></b> <a
                                        class="pull-right text-aqua"><?php
                            ...
                            if (($staff["is_active"] == 0)) {
                                ?>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('disable_date'); ?></b> <a
                                        class="pull-right text-aqua"><?php
                ...
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a href="#payroll" data-toggle="tab"
                                aria-expanded="true"><?php echo $this->lang->line('payroll'); ?></a></li>
                        <li class=""><a href="#leaves" data-toggle="tab"
                                aria-expanded="true"><?php echo $this->lang->line('leaves'); ?></a></li>
                        <li class=""><a href="#attendance" data-toggle="tab"
                                aria-expanded="true"><?php echo $this->lang->line('attendance'); ?></a></li>
                        ...
                        <?php if ($staff['user_type'] == 2) {
                            ...
                            <li class=""><a href="#reviews" data-toggle="tab"
                                    aria-expanded="true"><?php echo $this->lang->line('reviews'); ?></a></li>
                            <?php
                        }
                                    ...
                                    if ($logged_in_User_Role->id == 7) {
                                        if ($a) {
                                            ...
                                            <li class="pull-right"><a class="text-red" data-toggle="tooltip" data-placement="bottom"
                                                    ...
                                                    onclick="disable_staff('<?php echo $id; ?>');"></i> <i
                                                        class="fa fa-thumbs-o-down"></i></a></li>
                                            <?php
                                        }
                                    } else {
                                        ?>
                                        <li class="pull-right"><a href="<?php echo base_url('admin/staff/disablestaff/' . $id); ?>"
                                                class="text-red" data-toggle="tooltip" data-placement="bottom"
                                                title="<?php echo $this->lang->line('disable'); ?>"
                                                onclick="return confirm('<?php echo $this->lang->line('are_you_sure_you_want_to_disable_this_record'); ?>')"></i>
                                ...
                                if ($logged_in_User_Role->id == 7) {
                                    if ($a) {
                                        ?>
                                            ...
                                            <li class="pull-right"><a href="<?php echo base_url('admin/staff/delete/' . $id); ?>"
                                                    class="text-red" data-toggle="tooltip" data-placement="bottom"
                                                    title="<?php echo $this->lang->line('delete'); ?>"
                                                    onclick="return confirm('<?php echo $this->lang->line('are_you_sure_want_to_delete'); ?>');"></i><i
                                                        class="fa fa-trash"></i></a></li>
                                            <li class="pull-right"><a href="<?php echo base_url('admin/staff/enablestaff/' . $id); ?>"
                                                    class="text-green" data-toggle="tooltip" data-placement="bottom"
                                                    title="<?php echo $this->lang->line('enable'); ?>"
                                                    onclick="return confirm('<?php echo $this->lang->line('are_you_sure_you_want_to_enable_this_record'); ?>');"><i
                        ...
                        <li class="pull-right">
                            <?php if ($a) {
                                ?>
                                <a href="#" class="change_password text-green" data-toggle="tooltip" data-placement="bottom"
                                    title="<?php echo $this->lang->line('change_password'); ?>"></i> <i
                                        class="fa fa-key"></i></a>
                        ...
                        if ($this->rbac->hasPrivilege('staff', 'can_edit')) {
                            ...
                            if ($logged_in_User_Role->id == 7) {
                                if ($a) {
                                    ...
                                    <li class="pull-right"><a href="<?php echo base_url('admin/staff/edit/' . $id); ?>"
                                            data-toggle="tooltip" data-placement="bottom"
                                            title="<?php echo $this->lang->line('edit'); ?>" class="text-light"><i
                                    ...
                                    <table class="table table-hover table-striped tmb0">
                                        <tbody>
                                            <?php if ($sch_setting->staff_current_address) { ?>
                                                <tr>
                                                    <td class="col-md-4"><?php echo $this->lang->line('current_address'); ?>
                                                    </td>
                                ...
                                <div class="tshadow mb25 bozero">
                                    ...
                                    <div class="table-responsive around10 pt10">
                                        <table class="table table-hover table-striped tmb0">
                                            <tbody>
                                                <tr>
                                                    <td class="col-md-4"><?php echo $this->lang->line('account_title'); ?>
                                                    </td>
                                ...
                                <div class="tshadow mb25  bozero">
                                    ...
                                    <div class="table-responsive around10 pt0">
                                        <table class="table table-hover table-striped tmb0">
                                            <tbody>
                                                <tr>
                                                    <td class="col-md-4"><?php echo $this->lang->line('facebook_url'); ?>
                                                    </td>
                                                    <td class="col-md-5"><a href="<?php echo $staff['facebook']; ?>"
                                                            target="_blank"><?php echo $staff['facebook']; ?></a></td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo $this->lang->line('twitter_url'); ?></td>
                                                    <td><a href="<?php echo $staff['twitter']; ?>"
                                                            target="_blank"><?php echo $staff['twitter']; ?></a></td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo $this->lang->line('linkedin_url'); ?></td>
                                                    <td><a href="<?php echo $staff['linkedin']; ?>"
                                                            target="_blank"><?php echo $staff['linkedin']; ?></a></td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo $this->lang->line('instagram_url'); ?></td>
                                                    <td><a href="<?php echo $staff['instagram']; ?>"
                                                            target="_blank"><?php echo $staff['instagram']; ?></a></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                        ...
                        <div class="tab-pane" id="payroll">
                            ...
                            <div class="table-responsive">
                                <div class="download_label"><?php echo $this->lang->line('details_for'); ?>
                                    <?php echo $staff["name"] . " " . $staff["surname"] . $employee_id; ?></div>
                                <table class="table table-hover table-striped example">
                                    <thead>
                                        <tr>
                                            <th class="text text-left"><?php echo $this->lang->line('payslip'); ?> #
                                            </th>
                                            <th class="text text-left">
                                                <?php echo $this->lang->line('month_year'); ?><span></span></th>
                                            <th class="text text-left"><?php echo $this->lang->line('date'); ?></th>
                                            <th class="text text-left"><?php echo $this->lang->line('mode'); ?></th>
                                            <th class="text text-left"><?php echo $this->lang->line('status'); ?></th>
                                            <th class="text text-right"><?php echo $this->lang->line('net_salary'); ?>
                                        ...
                                        foreach ($staff_payroll as $key => $payroll_value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text text-right">
                                                    <?php echo amountFormat($payroll_value['net_salary']); ?></td>
                                                <td class="text-right">
                                                    ...
                                                    <div class="timeline-item">
                                                        ...
                                                        <?php if (!empty($value["document"])) { ?>
                                                            <span class="time"><a class="defaults-c text-right"
                                                                    ...
                                                                    href="<?php echo base_url() . "admin/timeline/download_staff_timeline/" . $value["id"] ?>"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col20per">
                                    <div class="staffprofile">
                                        ...
                                        <h4 class="total_half_day"><?php echo count($countAttendance['Half Day']); ?>
                                        </h4>
                                        <div class="icon">
                                            <i class="fa fa-check-square-o"></i>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6">
                                            <div class="staffprofile">
                                                ...
                                                <p><?php echo $this->lang->line('available'); ?>:
                                                    <?php echo $ldvalue["alloted_leave"] - $ldvalue["approve_leave"] ?></p>
                                                <div class="icon">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($staff_leaves as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right white-space-nowrap"><a href="#leavedetails"
            ...
            <form id="timelineform" name="timelineform" method="post"
                ...
                <div class="modal-body pt0 pb0">
                    ...
                    <div id='timeline_hide_show'>
                        ...
                        <div class="">
                            <div class="form-group">
                                <label for=""><?php echo $this->lang->line('title'); ?></label><small class="req">
                                    *</small>
                            ...
                            <div class="form-group">
                                <label for=""><?php echo $this->lang->line('date'); ?></label><small class="req">
                                    *</small>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" id="changepassbtn" action="">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="email"><?php echo $this->lang->line('new_password'); ?> <small class="req">
                                *</small></label>
                        <input type="password" class="form-control" name="new_pass" id="pass">
                    </div>
                    <div class="form-group">
                        <label for="pwd"><?php echo $this->lang->line('confirm_password'); ?> <small class="req">
                                *</small></label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" id="disablebtn" action="">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="email"><?php echo $this->lang->line('date'); ?> <small class="req">
                                *</small></label>
