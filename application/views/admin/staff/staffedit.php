        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form id="form1" action="<?php echo site_url('admin/staff/edit/' . $staff["id"]) ?>"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input autofocus="" id="employee_id" name="employee_id" placeholder=""
                                                        value="<?php echo $staff["employee_id"] ?>" type="text"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="firstname" name="name" placeholder="" type="text"
                                                    class="form-control"
                                                    value="<?php echo set_value('name', $staff["name"]); ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="surname" name="surname" placeholder="" type="text"
                                                        class="form-control"
                                                        value="<?php echo set_value('surname', $staff["surname"]); ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="father_name" name="father_name" placeholder="" type="text"
                                                        class="form-control"
                                                        value="<?php echo set_value('father_name', $staff["father_name"]); ?>" />
                                                    <span
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mother_name" name="mother_name" placeholder="" type="text"
                                                        class="form-control"
                                                        value="<?php echo set_value('mother_name', $staff["mother_name"]); ?>" />
                                                    <span
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="email" name="email" placeholder="" type="text"
                                                    class="form-control"
                                                    value="<?php echo set_value('email', $staff["email"]); ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="date_of_joining" name="date_of_joining" placeholder=""
                                                        type="text" class="form-control date" value="<?php
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mobileno" name="contactno" placeholder="" type="text"
                                                        class="form-control"
                                                        value="<?php echo set_value('contactno', $staff["contact_no"]); ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mobileno" name="emergency_no" placeholder="" type="text"
                                                        class="form-control"
                                                        value="<?php echo set_value('emergency_no', $staff["emergency_contact_no"]); ?>" />
                                                    <span
                                    ...
                                    <div class="row">
                                        <?php if ($sch_setting->staff_current_address) { ?>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label
                                                        for="exampleInputFile"><?php echo $this->lang->line('current_address'); ?></label>
                                                    <div><textarea name="address"
                                                            class="form-control"><?php echo set_value('address', $staff["local_address"]) ?></textarea>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div><textarea name="permanent_address"
                                                            class="form-control"><?php echo set_value('permanent_address', $staff["permanent_address"]); ?></textarea>
                                                    </div>
                                                    <span class="text-danger"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="qualification" name="qualification" placeholder=""
                                                        class="form-control"><?php echo set_value('qualification', $staff["qualification"]); ?></textarea>
                                                    <span
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="permanent_address" name="work_exp" placeholder=""
                                                        class="form-control"><?php echo set_value('work_exp', $staff["work_exp"]) ?></textarea>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div><textarea name="note"
                                                            class="form-control"><?php echo set_value('note', $staff["note"]) ?></textarea>
                                                    </div>
                                                    <span class="text-danger"></span>
                                                </div>
                                            </div>
                                ...
                                <div class="panel box box-success collapsed-box">
                                    ...
                                    <div class="box-body">
                                        <div class="tshadow mb25 bozero">
                                            ...
                                            <div class="row around10">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="<?php echo $staff["basic_salary"] ?>"
                                                                class="form-control" name="basic_salary">
                                                        </div>
                                                    </div>
                                                <?php }
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo $this->lang->line('date_of_leaving'); ?></label>
                                                    ...
                                                    foreach ($leavetypeList as $key => $leave) {
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="ifsc_code" name="alloted_leave[]"
                                        ...
                                        if ($sch_setting->staff_social_media) { ?>
                                            <div class="tshadow mb25 bozero">
                                                <h4 class="pagetitleh2">
                                                    <?php echo $this->lang->line('social_media_link'); ?>
                                                </h4>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <table class="table">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td>3.</td>
                                                                                <td><?php echo $this->lang->line('resignation_letter'); ?>
                                                                                </td>
                                                                                <td>
                                                                                    <input class="filestyle form-control"
