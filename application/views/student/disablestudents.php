                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('student/disablestudentslist') ?>"
                                        method="post" class="">
                                    ...
                                    <table class="table table-striped table-bordered table-hover example" cellspacing="0"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <th class="pull-right noExport"><?php echo $this->lang->line('action'); ?>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            if (empty($resultlist)) {
                                                ...
                                                foreach ($resultlist as $student) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a
                                                                href="<?php echo base_url(); ?>student/view/<?php echo $student['id']; ?>"><?php echo $this->customlib->getFullName($student['firstname'], $student['middlename'], $student['lastname'], $sch_setting->middlename, $sch_setting->lastname); ?>
                                                            </a>
                                                        </td>
